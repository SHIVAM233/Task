...
<body>
    ...
    <form action="{{ url('upload') }}" method="POST" enctype="multipart/form-data" class="container mt-5">
    @csrf
        <div class="row">
            <div class="col-md-6">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="key" id="key" value="{{$randomKey}}" class="form-control" required readonly>
                </div>
            </div>
    ...
    <table border="1" style="border-collapse:collapse; width: 100%; max-width: 80%; margin-top: 20px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="{{ route('image.delete', $value->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this image?');">
                        @csrf
                        @method('DELETE')
